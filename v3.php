		...
		<div class="container" id="study_wrapper">
			...
			<h2>Questions About the Report</h2>
				...
				<form action="vis_task.php" method="post" id="v3_q">
					...
					<label for="v3_q1"><strong>The number of variants with low clinical importance:</strong></label><p>
					<input type="text" name="v3_q1" id="v3_q1"></p><p>
					
					<label for="v3_q2"><strong>The number of variants with high clinical importance:</strong></label></p><p>
					<input type="text" name="v3_q2" id="v3_q2"></p><p>
					
					<label for="v3_q3"><strong>The number of variants tat are well-established pathogenic:</strong></label></p><p>
					<input type="text" name="v3_q3" id="v3_q3"></p>

					<label for="v3_q4"><strong>The number of variants tat are uncertain pathogenic:</strong></label></p><p>
					<input type="text" name="v3_q4" id="v3_q4"></p>
					...
					<label class="radio" for="v3_q5_T">
						<input type="radio" name="v3_q5" id="v3_q5_T" value="True">True
					</label></p><p>
					<label class="radio" for="v3_q5_F">
						<input type="radio" name="v3_q5" id="v3_q5_F" value="False">False
					</label></p><p>


					<p><strong>Which of the following variants would Jaime be most likely to discuss with a healthcare provider?</strong></p><p>
					
					<label class="radio" for="v3_q6_A">
						<input type="radio" name="v3_q6" id="v3_q6_A" value="rs1544410">rs1544410
					</label></p><p>
					<label class="radio" for="v3_q6_B">
						<input type="radio" name="v3_q6" id="v3_q6_B" value="SERPINA1-E366K">SERPINA1-E366K
					</label></p><p>
					<label class="radio" for="v3_q6_C">
						<input type="radio" name="v3_q6" id="v3_q6_C" value="MTRR-I49M">MTRR-I49M
					</label></p><p>
					<label class="radio" for="v3_q6_D">
						<input type="radio" name="v3_q6" id="v3_q6_D" value="CACNA1S-L458H">CACNA1S-L458H
					</label></p><p>
					...
					<label for="v3_q11">Please use the space below to tell us how we can improve the report to make it easier to understand.</label></p><p>
