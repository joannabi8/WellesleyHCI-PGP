...
<html>
	<head>
		<title>PGHCI Visualization: Bar Chart</title>
		<!--Google TreeMap API-->
...
<script type="text/javascript" src="https://www.google.com/jsapi"></script>
    ...
    <script type="text/javascript">
        ...
        var chartWidth = '1750px';
        var legendHeight = '375px';
      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          ['FUT2-W154X',          1,                  '#1e90ff',        'Variant Name: FUT2-W154X' + '\n' +
                                                                             'Clinical Importance: Medium' + '\n' + 
          ...
          //Low Clinical Importance: 
             ...
             ['LIG4-A3V',            5,                  '#bdbdbd',         'Variant Name: LIG4-A3V' + '\n' +
                    ...
                    ['NEFL-S472Shift',      4,          /*   '#7d967d', */ '#a5d2ff',        'Variant Name: NEFL-S472Shift' + '\n' +
                                                                                 'Clinical Importance: Low' + '\n' + 
                    ...
                    ['MSH2-G322D',          4,       /*   '#7d967d', */ '#a5d2ff',         'Variant Name: MSH2-G322D' + '\n' +
                                                                                 'Clinical Importance: Low' + '\n' + 
                                                                                 'Impact: Likely Benign' + '\n' +  
                                                                                 'Status: Unknown, Heterozygous' + '\n' + 
                    ...
                    ['CACNA1S-L458H',       4,       /*   '#7d967d', */ '#a5d2ff',       'Variant Name: CACNA1S-L458H' + '\n' +
                                                                                 'Clinical Importance: Low' + '\n' + 
                                                                                 'Impact: Likely Benign' + '\n' +  
                                                                                 'Status: Unknown, Heterozygous' + '\n' + 
                                                                                 'Allele Frequency: 27%' + '\n' + 
                    ...
                    ['ADA-K80R',            4,       /*   '#7d967d', */ '#a5d2ff',      'Variant Name: ADA-K80R' + '\n' +
                                                                                 'Clinical Importance: Low' + '\n' + 
                                                                                 'Impact: Likely Benign' + '\n' +  
                                                                                 'Status: Recessive, Carrier (Heterozygous)' + '\n' + 
                    ...
                    ['COL9A2-T246M',        4,        /*   '#7d967d', */ '#a5d2ff',         'Variant Name: COL9A2-T246M' + '\n' +
                                                                                 'Clinical Importance: Low' + '\n' + 
                                                                                 'Impact: Likely Benign' + '\n' +  
                                                                                 'Status: Unknown, Heterozygous' + '\n' + 
                    ...
                    ['FANCI-P55L',          4,       /*   '#7d967d', */ '#a5d2ff',         'Variant Name: FANCI-P55L' + '\n' +
                                                                                 'Clinical Importance: Low' + '\n' + 
                                                                                 'Impact: Likely Benign' + '\n' +  
                                                                                 'Status: Unknown, Heterozygous' + '\n' + 
                    ...
                    ['PKD1-A4059V',         4,         /*   '#7d967d', */ '#a5d2ff',        'Variant Name: PKD1-A4059V' + '\n' +
                                                                                 'Clinical Importance: Low' + '\n' + 
                                                                                 'Impact: Likely Benign' + '\n' +  
                                                                                 'Status: Unknown, Heterozygous' + '\n' + 
                   ...
                   ['ARSA-N350S',          3,               /* '#659665',*/ '#78bcff',         'Variant Name: ARSA-N350S' + '\n' +
                                                                                 'Clinical Importance: Low' + '\n' + 
                  ...
                  ['IL7R-T244I',          2,          /*   '#4d994d', */ '#4aa6ff',       'Variant Name: IL7R-T244I' + '\n' +
                                                                                 'Clinical Importance: Low' + '\n' + 
                    ...
                    ['KCNJ11-K23E',         2,          /* '#4d994d', */ '#4aa6ff',        'Variant Name: KCNJ11-K23E' + '\n' +
                                                                                 'Clinical Importance: Low' + '\n' + 
                                                                                 'Impact: Likely Protective' + '\n' +  
                                                                                 'Status: Unknown, Homozygous' + '\n' + 
                                                                                 'Allele Frequency: 74%' + '\n' + 
...
<div>
   ...
   <!-- <img src="file:///Users/johannaokerlund/Desktop/hci2014/axisBubble.jpg" height="240px" style="left:65px; top:73px; position:absolute">  -->
    <!--<canvas id="myCanvas" width="20" height="400"
            style="border:1px solid #000000; position:relative">
        </canvas>-->
</div>
<!--    <div id="textKey" style="width:" chartWidth>

    </div>
    <a style = "position:absolute; TOP:362px; LEFT:150px">High Clinical<br>Importance</a>
    <a style = "position:absolute; TOP:362px; LEFT:270px">Medium Clinical<br>Importance</a>
    <a style = "position:absolute; TOP:362px; LEFT:600px">Low Clinical Importance</a>
    <a style = "position:absolute; TOP:390px; LEFT:500px; "><i><font size="2">Variant</font></i></a>-->
...
<input type="hidden" name="q9a">
	  ...
	  <label><input type="checkbox" name="q9h"  value="eye">Eye Disease</label>
				...
				<input class="btn btn-primary submit-survey" type="submit" name="Submit" value="Continue" id="Submit_v3">
			</form>
		</div>
