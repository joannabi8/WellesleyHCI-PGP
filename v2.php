...
<!--ADDED STUFF HERE -->
	...
	<body>
		...
		<div class="container" id="study_wrapper">
			...
			<p>The report shows a TreeMap visualization of gene variants. TreeMaps show information in a visual and interactive way. In Jamie's report, the TreeMap shows three rectangles for the three levels of genetic results: low clinical importance, medium clinical importance and high clinical importance. </p>
			<p>You can click on any of these rectangles to see the variants in the category, or you may navigate from level to level using the labeled buttons above the TreeMap. </p>
			<p>When you click on one of the categories, the TreeMap shows you more rectangles, each representing a gene variant. </p>
			<p>The color of a gene variant represents its potential impact. Red rectangles represent pathogenic gene variants, white rectangles represent benign gene variants, and blue rectangles represent protective gene variants. The saturation (i.e. intensity) of a color represents the certainty of the impact. For example, red gene variants are well established pathogenic but pink gene variants are only likely, or possibly, pathogenic.</p>
			<p>For each gene variant the TreeMap presents its name, and when you hover over the rectangle, additional information is provided, including a summary about the medical conditions the gene variants is associated with.</p>
