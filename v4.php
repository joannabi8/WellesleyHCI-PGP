       ...
       <embed width="900" height="800" src="http://savedbythegoog.appspot.com/?id=314b80be054ceefb90730c8733abc5e71ff612d1" scale="tofit" frameborder="5"></embed>
			...
			<h2>Questions About the Report</h2>
				...
				<form action="vis_process.php" method="post" id="v4_q">
					...
					<label for="v4_q3"><strong>Based on the information above, is the number of variants in Jamie's report with low clinical importance greater than, equal to, or less than the number of variants with high clinical importance?</strong></label>
					...
					<label for="v4_q4"><strong>Based on the information above, is the number of uncertain pathogenic variants in Jamie's report greater than, equal to, or less than the number of well established pathogenic variants?</strong></label>
