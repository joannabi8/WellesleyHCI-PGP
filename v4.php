		...
		<div class="container" id="study_wrapper">
			...
			<h2>Questions About the Report</h2>
				...
				<form action="vis_process.php" method="post" id="v4_q">
					...
					<label for="v4_q1"><strong>The number of variants with high clinical importance:</strong></label></p><p>
					<input type="text" name="v4_q1" id="v4_q1"></p><p>
					
					<label for="v4_q2"><strong>The number of variants that are well-established pathogenic:</strong></label></p><p>
					<input type="text" name="v4_q2" id="v4_q2"></p>

					<label for="v4_q3"><strong>Based on the information above, is the number of variants in Jamie's report with low clinical importance greater than, equal to, or less than the number of variants with high clinical importance?</strong></label><p>
					<label class="radio" for="v4_q3_A">
						<input type="radio" name="v4_q3" id="v4_q3_A" value="greater">Greater than
					</label></p><p>
					<label class="radio" for="v4_q3_B">
						<input type="radio" name="v4_q3" id="v4_q3_B" value="equal">Equal
					</label></p><p>
					<label class="radio" for="v4_q3_C">
						<input type="radio" name="v4_q3" id="v4_q3_C" value="less">Less than
					</label></p><p>
					<label class="radio" for="v4_q3_D">
						<input type="radio" name="v4_q3" id="v4_q3_D" value="dunno">I don't know
					</label></p><p>
					...
					<label for="v4_q11">Please use the space below to tell us which features were most helpful for understanding the report.</label></p><p>
