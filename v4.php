		...
		<div class="container" id="study_wrapper">
			...
			<h2>Questions About the Report</h2>
				...
				<form action="vis_process.php" method="post" id="v4_q">
					...
					<label for="v4_q1"><strong>Based on the information above, is the number of variants in Jamie's report with low clinical importance greater than, equal to, or less than the number of variants with high clinical importance?</strong></label><p>
					<label class="radio" for="v4_q1_A">
						<input type="radio" name="v4_q1" id="v4_q1_A" value="greater">Greater than
					</label></p><p>
					<label class="radio" for="v4_q1_B">
						<input type="radio" name="v4_q1" id="v4_q1_B" value="equal">Equal
					</label></p><p>
					<label class="radio" for="v4_q1_C">
						<input type="radio" name="v4_q1" id="v4_q1_C" value="less">Less than
					</label></p><p>
					<label class="radio" for="v4_q1_D">
						<input type="radio" name="v4_q1" id="v4_q1_D" value="dunno">I don't know
					</label></p><p>
					...
					<label for="v4_q3"><strong>The number of variants that are well-established pathogenic:</strong></label></p><p>
					<input type="text" name="v4_q3" id="v4_q3"></p>

			
					<label for="v4_q4"><strong>Based on the information above, is the number of uncertain pathogenic variants in Jamie's report greater than, equal to, or less than the number of well established pathogenic variants?</strong></label><p>
					<label class="radio" for="v4_q4_A">
						<input type="radio" name="v4_q4" id="v4_q4_A" value="greater">Greater than
					</label></p><p>
					<label class="radio" for="v4_q4_B">
						<input type="radio" name="v4_q4" id="v4_q4_B" value="equal">Equal
					</label></p><p>
					<label class="radio" for="v4_q4_C">
						<input type="radio" name="v4_q4" id="v4_q4_C" value="less">Less than
					</label></p><p>
					<label class="radio" for="v4_q4_D">
						<input type="radio" name="v4_q4" id="v4_q4_D" value="dunno">I don't know
					</label></p><p>
					...
					<label class="radio" for="v4_q5_A">
						<input type="radio" name="v4_q5" id="v4_q5_A" value="greater">Greater than
					</label></p><p>
					<label class="radio" for="v4_q5_B">
						<input type="radio" name="v4_q5" id="v4_q5_B" value="equal">Equal
					</label></p><p>
					<label class="radio" for="v4_q5_C">
						<input type="radio" name="v4_q5" id="v4_q5_C" value="less">Less than
					</label></p><p>
					<label class="radio" for="v4_q5_D">
						<input type="radio" name="v4_q5" id="v4_q5_D" value="dunno">I don't know
					</label></p><p>
					...
					<label for="v4_q11">Please use the space below to tell us how we can improve the report to make it easier to understand.</label></p><p>
					<textarea name="v4_q11" id="v4_q11" cols="30" rows="5"></textarea>
					</p><p>
					
					<label for="v4_q12">Please use the space below to tell us which features were most helpful for understanding the report.</label></p><p>
